							...
							<div class="row">
								<div class="col-sm-12 form-group">
									<select id="searchType" name="searchType" class="form-control1">
										...
										value="${cri.keyword }" class="form-control1"> <select
										id="foodName" name="foodName" class="form-control1">
									...
									<button id="trucksearchBtn" class="btn btn-common btn-sm">검색</button>
								</div>
							</div>
						</div>
					</div>
										...
										<div class="portfolio-thumb">
											...
											<c:if test="${not empty truckUser.truckImg}">
												<img
													...
													class="img-responsive" style="height: 440px; width: 220px;"
													alt="">
											</c:if>
										</div>
