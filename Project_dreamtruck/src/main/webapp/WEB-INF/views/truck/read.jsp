			...
			$.ajax({
				...
				success: function(result){
						if (result == 'SUCCESS') {
							$('#like').show();
							$('#unlike').hide();
							swal("등록 성공!", "관심트럭으로 등록되었습니다.", "success").then(function(){
								reviewPage=1;
								getPage("/truck/read?userId="+targetId);
								location.reload();
							});
						...
						<div class="col-md-12 col-sm-12">
							<div class="single-blog blog-details two-column">
								<div class="post-thumb">
									<a> <c:if test="${empty truckUser.truckImg}">
								...
								<div class="post-content overflow">
									...
									<div class="col-md-6">
										<table class="table talbe-hover">
											...
											<tr>
												<td id="map" style="height: 539px;"></td>
											</tr>
										</table>
									</div>
									...
									<div class="post-bottom overflow">
										...
										<ul class="nav navbar-nav post-nav">
											<span><li id="liketruck"><a><i
														class="fa fa-heart" id="like" style="cursor: pointer;"></i> <i
											...
											<c:choose>
												<c:when test="${empty login.userId}">
													<div class="box-body">
														...
														<textarea class="form-control" cols="50"
															...
															placeholder="로그인 후 사용 가능합니다" rows="5" disabled="disabled"></textarea>
														<div class="box-footer text-right">
															<div class="stars starrr" data-rating="0" id="star"
												...
												<c:otherwise>
													<div class="box-body">
														...
														<textarea class="form-control" cols="50"
															id="newReviewText" name="comment" placeholder="댓글을 남겨주세요"
															rows="5"></textarea>
														<div class="box-footer text-right">
															<div class="stars starrr" data-rating="0" id="star"></div>
									...
									<div>
										<ul class="timeline">
											<li class="time-label" id="reviewDiv"
												...
												style="color: #fd9483; margin-right: 10px;"></i><a
												id="reviewopen" style="color: #fd9483;">트럭 리뷰 펼치기</a></span></li>
										</ul>
										...
										<div class="modal-dialog">
											...
											<div class="modal-content">
												...
												<div class="modal-body" data-reviewId>
													...
													<input type="text" id="reviewtext" class="form-control">
													</p>
												</div>
