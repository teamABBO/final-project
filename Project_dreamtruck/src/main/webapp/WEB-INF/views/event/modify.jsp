...
<body>
	...
	<!-- 행사수정 -->
	<form class="form-horizontal" method="post" role="form" id="form1"
		enctype="multipart/form-data" action="modify">
		<input type="hidden" name="page" value="${cri.page }"> <input
			type="hidden" name="perPageNum" value="${cri.perPageNum}"> <input
			type="hidden" name="searchType" value="${cri.searchType}"> <input
			type="hidden" name="keyword" value="${cri.searchType}">
		<fieldset>
			<!-- 행사 게시판 번호 -->
			<div class="form-group">
				<label class="col-md-4 control-label">행사 게시판 번호</label> <label
					id="eventId"></label>
				<div class="col-md-4">
					<input id="eventId" name="eventId" type="text"
						class="form-control input-md" maxlength="16"
						value="${event.eventId }" readonly="readonly"> <input
			...
			<div class="form-group">
				<br>
				<br> <label class="col-md-4 control-label" for="title">제목</label>
				<div class="col-md-4">
					<input id="title" name="title" type="text"
						class="form-control input-md" value="${event.title }"> <label
						class="col-md-4 control-label" for="title"></label>
				</div>
			</div>

			<!-- 행사시작날짜 -->
			<div class="form-group">
				<label class="col-md-4 control-label">행사시작날짜</label> <label
					id="startDate"></label>
				<div class="col-md-4">
			...
			<!-- 행사기간 -->
			<div class="form-group">
				<label class="col-md-4 control-label">행사기간</label> <label
					id="duration"></label>
				<div class="col-md-4">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="recruit" name="recruit" type="number"
						class="form-control input-md" value="${event.recruit }">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					...
					</select> <select id="guId" name="guId" class="form-control"
						value="${event.guId }">
							...
							<div class="form-group">
								<div class="input-group">
									<span class="input-group-btn"> <input type="text"
										class="form-control"
										style="margin-left: 15px; margin-top: 2px;" id="img"
										name="img" value="${event.img}"> <span
								...
								<c:if test="${empty event.img}">
									<img id='img-upload'
										...
										src="/displayFile?fileName=/event/noimage.png" />
								</c:if>
								<c:if test="${not empty event.img}">
									<img id='img-upload'
										style="margin-left: 20px; margin-top: 10px;"
										src="/displayFile?fileName=/event${event.img}" />
								</c:if>
							</div>
						</div>
					</div>
