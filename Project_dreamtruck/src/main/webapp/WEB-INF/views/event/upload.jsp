	...
	<form class="form-horizontal" method="post" role="form" id="form1"
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="title" name="title" type="text" placeholder="제목을 입력하세요."
						class="form-control input-md" required> <label
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="startDate" name="startDate" type="date"
						placeholder="행사 시작 날짜를 입력해주세요." class="form-control input-md"
						maxlength="16">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="duration" name="duration" type="number" min="1"
						placeholder="행사기간을 입력해주세요." class="form-control input-md"
						maxlength="16">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="recruit" name="recruit" type="number" min="1"
						placeholder="모집트럭 수를 입력 해 주세요." class="form-control input-md"
						required>
				</div>
			</div>
