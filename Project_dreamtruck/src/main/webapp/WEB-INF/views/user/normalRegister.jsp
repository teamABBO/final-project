	...
	<form class="form-horizontal" method="post" role="form"
		...
		<fieldset>
			...
			<div class="form-group">
				<br>
				<br> <label class="col-md-4 control-label">아이디</label>
			...
			<!-- 전화번호 -->
			<div class="form-group">
				<label class="col-md-4 control-label">전화번호 </label> <label
					id="phoneLabel"></label>
				<div class="col-md-4">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="name" name="name" type="text"
						placeholder="이름을 입력 해 주세요." class="form-control input-md"
						required="">
				</div>
			</div>
