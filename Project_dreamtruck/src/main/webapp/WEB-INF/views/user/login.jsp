...
<body>
	...
	<!-- 본문 -->
	<br>
	<img alt="" src="/resources/images/home/welcome.png"
			...
			<div
				...
				<form action="loginPost" method="post" onsubmit="return check();">
					<fieldset>
						...
						<span class="button-checkbox"> <!-- <button type="button" class="btn" data-color="info">아이디 저장</button> -->
							<input type="checkbox" name="useCookie" id="useCookie"
							checked="checked" class="hidden"> <!-- <a href="find" class="btn btn-link pull-right">아이디  & 비밀번호를 잊어 버리셨습니까?</a> -->
				...
				function check(){
					...
					if($.trim($("#pw").val())==""){
						...
						return false;
							...
							<div class="col-xs-6 col-sm-6 col-md-6">
								<input type="submit" class="btn btn-lg btn-common box-radius2"
									value="로그인">
							...
							<br>
							<br>
							<br> <a href="find" class="btn btn-link"
								style="margin-left: 50px;">아이디 & 비밀번호를 잊어 버리셨습니까?</a> <a
								href="registertype" class="btn btn-link"
								style="margin-left: 100px; color: #fd9483;">회원가입</a>
						</div>
					</fieldset>
				</form>
			</div>
