...
<body>
	...
	<div style="margin: auto; margin-top: 20px;">
		<table>
			<tr>
				<td id="map_canvas" style="width: 500px; height: 500px;"></td>
				<td style="width: 10px; height: 10px;"></td>
				<td style="width: 150px; height: 150px;">
					<li>지역이동을 통해 <br>&emsp;&nbsp;&nbsp;원하는 지역으로 <br>&emsp;&nbsp;&nbsp;이동해보세요.
				</li>
				<br>
					<li>지도의 확대/축소를 <br>&emsp;&nbsp;&nbsp;통해 원하는 지역<br>&emsp;&nbsp;&nbsp;으로
						이동해보세요.
				</li>
				<br>
					<li>푸드트럭을 운영할 <br>&emsp;&nbsp;&nbsp;장소를 찾아 클릭<br>&emsp;&nbsp;&nbsp;하세요.
				</li>
				<br>
					<li>주소를 확인하고 <br>&emsp;&nbsp;&nbsp;'확인'버튼을 클릭<br>&emsp;&nbsp;&nbsp;하세요.
				</li>
				</td>
			</tr>
		</table>
	</div>
	<button class="btn btn-common" id="place"
		style="float: right; margin-top: 20px; margin-right: 20px;">확인</button>
</body>
</html>
