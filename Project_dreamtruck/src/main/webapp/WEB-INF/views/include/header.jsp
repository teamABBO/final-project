        ...
        <c:if test="${empty login}">
          <div class="social-icons pull-right">
            <ul class="nav nav-pills">
              ...
              <li><a href="/user/registertype"
                style="color: #fd9691">회원가입</a></li>
            </ul>
          </div>
        </c:if>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown"><a style="color: #fd9691" href="/event/list">행사 <i
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-xs-12">
              ...
              <div
                style="text-align: center; font-size: 10pt; margin: 16px;">
                <span style="color: #2e77bc;"><i
                  class="fa fa-info-circle"></i></span>로그아웃하시면 서비스에 제한이 될 수
                있습니다.
              </div>
