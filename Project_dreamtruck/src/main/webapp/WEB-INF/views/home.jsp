      ...
      <div class="container">
        <div class="main-slider">
          <div class="slide-text">
            ...
            <p>
              축제행사 정보를 한 눈에 보길 원하시나요?<br>푸드트럭 영업이 허용된 장소와<br>내가
              원하는 장소에 영업 신청을 해보세요.
            </p>
      ...
      <br>
        <div class="single-features">
          <div class="col-sm-5 wow fadeInLeft" data-wow-duration="500ms"
           ...
           <div class="col-sm-6 wow fadeInRight"
            ...
            <h2>푸드트럭 연동 서비스</h2>
            <P>푸드트럭 영업구역이 한정적이기에 항상 같은 곳만 다니고있나요?
        ...
        <div class="single-features">
          <div class="col-sm-6 col-sm-offset-1 align-right wow fadeInLeft"
            ...
            필수 서류만 업로드 했다면 한 번의 클릭으로 손쉽게 운영신청을 할 수 있습니다.  
         </P>
          </div>
        ...
        <div class="single-features">
          <div class="col-sm-6 col-sm-offset-1 align-right wow fadeInLeft"
            data-wow-duration="500ms" data-wow-delay="300ms">
            <h2>관심트럭 알림서비스</h2>
            <P>드림트럭과 함께하는 푸드트럭 중 좋아하는 트럭은 관심트럭으로 등록하세요! 나의 관심 트럭이 영업을 시작하거나 내 근처에서 운영 중이라면 휴대폰 알림서비스를 받을 수 있습니다.  
         </P>
          </div>
          <div class="col-sm-5 wow fadeInRight"
            data-wow-duration="500ms" data-wow-delay="300ms">
